...
<body style="height: 100vh; display: flex; flex-direction: column; overflow: hidden;">
  ...
  <div class="col-9 border-left custom-form">
      <br>
      <div>
        <h4 class="mb-3">Nuevo Proveedor 
        <a href="../AdministradorProveedores.php"><button class="btn btn-lg float-end custom-btn btn-secondary" type="submit"
      ...
      action="../FormLogic/CrearProveedor.php" novalidate>
          <div class="row g-3">
            <div class="col-sm-6">
              <label id="nitProveedor" for="number" class="form-label">NIT</label>
            ...
            <div class="col-sm-6">
            <label id="nombreProveedor" for="name" class="form-label">Nombre</label>
          ...
          <div class="col-md-6">
            ...
            <button class="btn btn-success float-end custom-btn" style="font-size: 15px;"
              type="submit">Registrar Proveedor</button>
            </div>
            </div>
            </form>
      </div>
