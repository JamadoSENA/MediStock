...
<body style="height: 100vh; display: flex; flex-direction: column; overflow: hidden;">
  ...
  <div class="col-9 border-left custom-form">
      ...
      <div class="col-md-6">
            ...
            <option value=""><?php echo $row['departamentoUsuario']?></option>  
          ...
          <div class="col-md-6">
            ...
            <option value=""><?php echo $row['municipioUsuario']?></option>  
            <option value="">Elegir...</option>
            </select>
          </div>
      <div class="col-sm-6">
      <label id="Direccion" for="text" class="form-label">Direccion</label>
      <input name="Direccion" type="text" class="form-control" 
       value="<?php echo $row['direccionUsuario']?>">
      </div>
      <div class="col-sm-6">
      <label id="Telefono" for="text" class="form-label">Telefono</label>
      <input name="Telefono" type="text" class="form-control" 
       value="<?php echo $row['telefonoUsuario']?>">
      </div>
      <div class="col-sm-6">
      <label id="Correo" for="text" class="form-label">Correo</label>
      <input name="Correo" type="email" class="form-control" 
       value="<?php echo $row['correoUsuario']?>">
      </div>
      <div class="col-sm-6">
      <label id="Contrasenia" for="text" class="form-label">Contrasenia</label>
      <input name="Contrasenia" type="text" class="form-control" 
       value="<?php echo $row['contraseniaUsuario']?>">
      </div>
      </div>
      <div class="py-4">
