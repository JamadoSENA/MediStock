            ...
            <tr>
              ...
              <td scope="row">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item text-danger" class="dropdown-item" href="FormLogic/EliminarUsuario.php?php echo $resultado['idUsuario']; ?>">Archivar <svg xmlns="http://www.w3.org/2000/svg" width="16"
