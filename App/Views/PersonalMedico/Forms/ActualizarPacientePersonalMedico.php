...
<body style="height: 100vh; display: flex; flex-direction: column; overflow: hidden;">
  ...
  <div class="col-9 border-left custom-form">
      <br>
      <div>
      <h4 class="mb-3">Actualizar Paciente
        <a href="../PersonalMedicoPacientes.php"><button class="btn btn-lg float-end custom-btn btn-secondary"
      ...
      ?>
      <div class="row g-3">
      <form id="" class="needs-validation" method="post" action="../FormLogic/ActualizarPaciente.php" novalidate>
      <input type="hidden" class="form-control" name="idPatient" value="<?php echo $row['idPatient'] ?>">
      <div class="col-sm-6">
      ...
      <button class="btn btn-success float-end custom-btn" style="font-size: 15px;"
       type="submit">Actualizar Paciente</button>
      </div>
      </form>
    </div>
  </div>
